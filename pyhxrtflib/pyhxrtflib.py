...
class PyTextRtf(tk.Text):
    ...
    def _insert_char(self, event):
        ...
        pos = hx_index(cursor)
        self.rtflib.insert_char(event, pos.row, pos.col)
    ...
    def _ignore_keys(self, event):
        if event.char in IGNORE_CHARS and event.keysym in IGNORE_KEYS:
            return True
        return False
